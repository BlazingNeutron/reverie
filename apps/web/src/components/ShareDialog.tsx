      ...
      >
        ...
        <div className="mt-6 flex justify-end gap-8">
          <Dialog.Close asChild>
            <Button variant="solid" aria-label="Done">
              Done
            </Button>
          </Dialog.Close>
          <Dialog.Close asChild>
        ...
        <Dialog.Close asChild>
          <button
            className="absolute right-2.5 top-2.5 inline-flex size-[25px] items-center justify-center rounded-full light:bg-gray-200 dark:bg-gray-500 hover:bg-accent focus:shadow-[0_0_0_2px] focus:shadow-violet7 focus:outline-none"
            aria-label="Close"
            type="button"
          >
            <Cross2Icon />
